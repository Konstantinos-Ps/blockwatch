<script lang="ts">
    ...
    const newsQuery = createQuery({
        queryKey: ["the-guardian"],
        queryFn: async () => {
            const res = await fetch("/api/the-guardian");
    ...
    const pageTitle = "The Guardian - Blockwatch";
    const pageDescription =
        "Stay updated with the latest crypto news and trends from The Guardian.";
    const pageKeywords =
